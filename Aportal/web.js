...
async function insert(req, res, qs) {
    try {
        var db = client.db('webinar');  // Database name
        var collection = db.collection('web_details');  // Collection name

        var data = {
            Email: qs["email"],
            webinarTitle: qs["title"],
            date: qs["date"],
            time: qs["time"],
            fee: qs["fee"],
            count:qs["count"],
                ...
                <div class="container">
                    <div class="alert-container">
                        ...
                        <div class="alert" role="alert">
                            Webinar submitted successfully!
                        </div>
                    </div>
                </div>
            </body>
